...
const printCircleCalculations = (radius) => {
  console.log(
    `The circumference of the circle is ${calcCircumference(radius)}`
  );
...
const friend1 = "sorrawit";
const friend2 = "piyangkoon";
const friend3 = "yothin";

console.log(friend1, friend2, friend3);

const friends = ["sorrawit", "piyangkoon", "yothin"];
...
const dave = {
  ...
  friend: ["Ken", "Ryu", "Vega"],
  calcAge: function () {
    this.age = 2004 - this.birthYear;
    return this.age;
  },
};

console.log(
  `${dave.firstName} ${dave.lastName} has ${dave.first.length} friends, and his best friends is ${dave.friend[0]}`
);
